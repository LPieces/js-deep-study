;(function(doc, tpl, tools){
    ...
    MyTab.prototype._init = function () {
        this._render();
        this._bindEvent();
    }
    ...
    MyTab.prototype._bindEvent = function () {
        ...
        this.el.addEventListener('click', this._handTabClick.bind(this, doms), false);
    }

    MyTab.prototype._handTabClick = function () {
        ...
        if(className === 'tab-item') {
            ...
            this._index = [].indexOf.call(_doms.oTabItems, tar);  // 新知识点 [].indexOf.call()
            // console.log(this._index)
            _doms.oTabItems[this._index].className += ' current';
